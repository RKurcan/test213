...
{
    public class EmployeeLateInEarlyOutReportApiController : ApiController
    {

        public KendoGridResult<List<EmployeeLateInEarlyOutReportVm>> GenerateReport(KendoReportViewModel vm)
        {
            SEmployeeLateInEarlyOutReport services = new SEmployeeLateInEarlyOutReport();
            int[] employees;
            ...
            return new KendoGridResult<List<EmployeeLateInEarlyOutReportVm>>()
            {
