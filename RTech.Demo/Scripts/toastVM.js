    ...
    var toast = function () {
        ...
        self.displayLongToasts = function () {
            ...
            toaster.note({
                ...
                msg: 'Lorem ipsum dolor sit amet, eet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.',
                timeout: 25000,
                clickToClose: true
            });
            ...
            toaster.note({
                ...
                msg: 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.',
                timeout: 25000,
                clickToClose: true
            });
        };
        ...
        self.displayStandardToasts = function () {
            ...
            toaster.note({
                ...
                msg: 'Lorem ipsum dolor sit amet, nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.',
                timeout: 7000
            });

            /* Standard Toast (timout 4sec) with image */
            toaster.note({
                msg: ' Dhoni Lorem ipsum dolor sit amet, nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.',
                timeout: 4000
            });
            ...
            toaster.note({
                title: 'Lorem ipsum dolor sit amet',
                msg: 'Raina Lorem ipsum dolor sit amet, c euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.',
                timeout: 5000
            });
        };
