function getCalendarDivString(t) {
...
} function showCalendar(t) { $("#ndp-nepali-box table").find("tr:gt(0)").remove(), "" === t ? $("#ndp-nepali-box table").append(getDateTable("")) : $("#ndp-nepali-box table").append(getDateTable(t)), "block" == $("#ndp-nepali-box").css("display") && $("#ndp-nepali-box").hide(), $("#ndp-nepali-box").fadeIn(100) } function getDateTable(t) {
    var e = "", n = ""
    if ("" === t) {
        var a = getNepaliDate()
...
} function performSelectMonth(t) { showCalendar((ndpAttr.npdYear ? $("#npd-year-select").val() : t) + "/" + $("#npd-month-select").val() + "/01") } function performSelectYear(t) { showCalendar($("#npd-year-select").val() + "/" + (ndpAttr.npdMonth ? $("#npd-month-select").val() : t) + "/01") } function getMonthSelect(t, e) {
...
} function hideCalendarBox(t) { t = void 0 !== t ? t : !0, $("#ndp-nepali-box").fadeOut(100), npdCalendarVisible = !1, t && ndpAttr.onChange && ndpAttr.onChange() } function BsAddDays(t, e) {
    var n = new NepaliDateConverter
    return n.add_bs_days(t, e)
} function BsDatesDiff(t, e) {
    var n = new NepaliDateConverter
    return n.count_bs_days(t, e) + 2
} function get2DigitNo(t) { return t = parseInt(t, 10), 10 > t ? "0" + t : "" + t } function getMonths() {
    ...
    return t
} function getNepaliMonthsInNepali() { return ["बैशाख", "जेठ", "अषाढ", "श्रावण", "भाद्र", "आश्विन", "कार्तिक", "मङ्सिर", "पौष", "माघ", "फाल्गुन", "चैत्र"] } function getNepaliMonth(t) {
    t = parseInt(t, 10)
    ...
    var response;
    try {
        response = e.ad2bs(getNepaliFormat(t));
    } catch (e) {
        response = "";
    }
    return response;
    ...
    return e
} function makeArray() { for (i = 0; i < makeArray.arguments.length; i++) this[i + 1] = makeArray.arguments[i] } function englishNo2Nep(t) {
    t = "" + t
...
} function bs2ad(t) { return days_count = this.count_bs_days(this.bs_date_eq, t), this.add_ad_days(this.ad_date_eq, days_count) } function ad2bs(t) { return days_count = this.count_ad_days(this.ad_date_eq, t), this.add_bs_days(this.bs_date_eq, days_count) } ndpAttr = {}, npdCalendarVisible = "", npdIgnoreMouseUp = !1, ndpData = [], function (t) {
    t.fn.nepaliDatePicker = function (e) {
        ...
        }), t("body").append(getCalendarDivString(ndpAttr)), t(".ndp-nepali-calendar, #ndp-nepali-box").hover(function () { mouse_is_inside = !0 }, function () { mouse_is_inside = !1 }), t("html").mouseup(function (e) { t(e.target).is(".ndp-click-trigger") || npdCalendarVisible && !mouse_is_inside && hideCalendarBox(!1) })
    }
}(jQuery)
